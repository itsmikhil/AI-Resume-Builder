...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = (index) => {
    ...
    setTimeout(() => {
      const enhancedText = `Worked as ${experience.position} at ${experience.company}, delivering measurable results and improving operational efficiency through strategic initiatives and cross-functional collaboration.`;
